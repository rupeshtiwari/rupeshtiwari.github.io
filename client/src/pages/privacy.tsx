  ...
  return (
    <div className="min-h-screen bg-[var(--theme-bg-primary)] text-[var(--theme-text-primary)]">
      <div className="container mx-auto px-6 py-16">
        ...
        >
          <Link href="/">
            <Button variant="ghost" className="mb-8 text-[var(--theme-text-secondary)] hover:text-[var(--theme-text-primary)]" data-testid="link-back-home">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-bold font-display text-[var(--theme-text-primary)]" data-testid="text-privacy-title">
              Privacy Policy
            </h1>
          </div>
          ...
          <div className="space-y-8 text-[var(--theme-text-secondary)]">
            <section className="p-6 rounded-2xl bg-[var(--theme-bg-card)]/80 border border-[var(--theme-border)]">
              <div className="flex items-center gap-3 mb-4">
                <Lock className="w-5 h-5 text-[#D4AF37]" />
                <h2 className="text-xl font-bold text-[var(--theme-text-primary)]">Information We Collect</h2>
              </div>
            ...
            <section className="p-6 rounded-2xl bg-[var(--theme-bg-card)]/80 border border-[var(--theme-border)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-[var(--theme-text-primary)]">How We Use Your Information</h2>
              </div>
            ...
            <section className="p-6 rounded-2xl bg-[var(--theme-bg-card)]/80 border border-[var(--theme-border)]">
              <h2 className="text-xl font-bold text-[var(--theme-text-primary)] mb-4">Data Protection</h2>
            ...
            <section className="p-6 rounded-2xl bg-[var(--theme-bg-card)]/80 border border-[var(--theme-border)]">
              <h2 className="text-xl font-bold text-[var(--theme-text-primary)] mb-4">Third-Party Services</h2>
              <p className="leading-relaxed">
            ...
            <section className="p-6 rounded-2xl bg-[var(--theme-bg-card)]/80 border border-[var(--theme-border)]">
              <h2 className="text-xl font-bold text-[var(--theme-text-primary)] mb-4">Your Rights</h2>
              <p className="leading-relaxed">
            ...
            <section className="p-6 rounded-2xl bg-[var(--theme-bg-card)]/80 border border-[var(--theme-border)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-[var(--theme-text-primary)]">Contact Us</h2>
              </div>
              <p className="leading-relaxed">
