...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-[var(--theme-bg-primary)] relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div className="relative mb-8">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-[var(--theme-border)]">
                <img 
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {certifications.map((cert, i) => (
                <motion.a
                  ...
                  className="p-4 rounded-xl bg-[var(--theme-bg-secondary)]/50 border border-[var(--theme-border)] text-center hover:border-amber-500/50 transition-colors group"
                >
                  <div className={`w-10 h-10 mx-auto mb-2 rounded-lg bg-gradient-to-br ${cert.color} flex items-center justify-center`}>
                    <BadgeCheck className="w-5 h-5 text-white" />
                  </div>
                  <div className="text-[var(--theme-text-primary)] text-sm font-medium flex items-center justify-center gap-1">
                    {cert.name}
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[var(--theme-text-primary)] font-semibold">5.0 Rating on IGotAnOffer</div>
                  <div className="text-[var(--theme-text-muted)] text-sm">51+ Verified Reviews</div>
                </div>
              </div>
              <ExternalLink className="w-5 h-5 text-[var(--theme-text-muted)] group-hover:text-yellow-500 transition-colors" />
            </a>
          </motion.div>
        </div>
      </div>
