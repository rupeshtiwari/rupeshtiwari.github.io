      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {content.map((item, idx) => (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-background flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-sm overflow-hidden">
                {item.title === "Fullstack Master" ? (
                  <img src="/assets/fsm-logo-square.jpeg" alt="Fullstack Master" className="w-full h-full object-cover" />
                ) : (
