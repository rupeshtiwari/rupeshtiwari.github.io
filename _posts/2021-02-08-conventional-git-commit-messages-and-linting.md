...
We will use [conventional commit](https://www.conventionalcommits.org/en/v1.0.0/) to enforce the discipline.
...
We will use [commitlint node package](https://commitlint.js.org/#/guides-local-setup?id=install-commitlint ) to enforce the constraints for commit message format. 
...
![](https://i.imgur.com/3LSunpY.png)

Commit error
![](https://i.imgur.com/q6kUXjw.png)
